<?php
/**
 * Class Alrenas_Email_Admin_New_Quote_Request file.
 *
 * @package Alrenas
 */
...
if ( class_exists( 'Alrenas_Email_Admin_New_Quote_Request', false ) ) {
	return new Alrenas_Email_Admin_New_Quote_Request();
}

/**
 * Notifies the shop admin whenever a customer submits a new quote request.
 */
class Alrenas_Email_Admin_New_Quote_Request extends WC_Email {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->id             = 'alrenas_admin_new_quote_request';
		$this->title          = esc_html__( 'New Quote Request (Admin)', 'alrenas' );
		$this->description    = esc_html__( 'Sent to the shop admin whenever a customer submits a "Get a Quote" request.', 'alrenas' );
	...
	public function get_default_subject() {
		return esc_html__( '[{site_title}] New quote request #{order_number}', 'alrenas' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'New quote request', 'alrenas' );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'additional_content' => array(
				'title'       => esc_html__( 'Additional content', 'alrenas' ),
				'description' => esc_html__( 'Text to appear below the main email content.', 'alrenas' ) . ' ' . $placeholder_text,
				'css'         => 'width:400px; height: 75px;',
				'placeholder' => esc_html__( 'N/A', 'alrenas' ),
				'type'        => 'textarea',
