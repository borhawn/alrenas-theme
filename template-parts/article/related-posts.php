...
<?php while ( $related->have_posts() ) : $related->the_post(); $categories = get_the_category(); ?><article class="related-card reveal"><?php if ( has_post_thumbnail() ) { the_post_thumbnail( 'large' ); } ?><div><div class="article-meta"><?php if ( $categories ) : ?><span class="category"><?php echo esc_html( $categories[0]->name ); ?></span><?php endif; ?></div><h3><?php the_title(); ?></h3><a class="text-link" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read article', 'alrenas' ); ?> <span aria-hidden="true">→</span></a></div></article><?php endwhile; ?>
</div></div></section>
